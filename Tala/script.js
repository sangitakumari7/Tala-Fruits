...
slide1h1.forEach(function(elem){
    gsap.to(elem, {
        x: '-100%', // Use x to animate the horizontal translation
        duration: 4,
        scrollTrigger: {
            trigger: "#page6",
            scroller: "#main",
            scrub: 1,
            start: "top center", // start when the top of #page6 hits the center of the viewport
            end: "bottom center"  // end when the bottom of #page6 hits the center of the viewport
        }
    })
})
var slide2h1 = document.querySelectorAll("#page6 .slide2-of-h1 h1"); // Corrected selector
slide2h1.forEach(function(elem){
    gsap.to(elem, {
        x: '0%', // Use x to animate the horizontal translation
        duration: 4,
        scrollTrigger: {
            trigger: "#page6",
            scroller: "#main",
